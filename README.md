...
- Design documents for each concept are called 'design' and each concept in the `/concepts` directory has one
- The overall design document highlighting interesting moments is called 'Application Design' under the `/learning` directory
